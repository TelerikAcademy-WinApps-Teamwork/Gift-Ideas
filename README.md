...
[Video](https://www.youtube.com/watch?v=-MriIyb4zCE&feature=youtu.be)
## App views
### Rgistration screen: 
...
### All gifts screen: 
![alt tag](screenshots/gifts.PNG)
### Gift details screen: 
![alt tag](screenshots/details.PNG)
### Add gift screen: 
![alt tag](screenshots/add.PNG)
### Map screen: 
![alt tag](screenshots/location.PNG)
